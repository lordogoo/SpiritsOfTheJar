...
/**
 * Write a description of class tutorialtriggerendbuttonspeech here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class tutorialtriggerendbuttonspeech extends triggeranimations
{
    ...
    public tutorialtriggerendbuttonspeech(gamepanel gp,String sp,String mess,BufferedImage b,JButton l)
    {
        super();
