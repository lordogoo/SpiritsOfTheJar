...
public class triggeranimation extends trigger
{
    ...
    public triggeranimation(animation anim)
    {      
    }
    ...
    public void prewait(){
        System.out.println("general animation trigger");
        target.invisibleall();
    ...
    public void postwait(){
        ...
        System.out.println("general animation trigger end");
    }
