...
public class triggeropponentendturn extends trigger
{

    menucontrol cont;
    matchmodel match;
    
    public triggeropponentendturn(menucontrol c,matchmodel m)
    {
        cont = c;
        match = m;
    }
    ...
    public void trigger(gamepanel target){
        this.target = target;
        if(match.getvictory().playerwinner(match)==false){
