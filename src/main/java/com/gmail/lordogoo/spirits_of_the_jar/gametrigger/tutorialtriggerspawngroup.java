...
public class tutorialtriggerspawngroup extends triggeranimations
{
    ...
    public tutorialtriggerspawngroup(gamepanel gp)
    {
        super();
        namepanel = gp;
    ...
    public void startanimation(gamepanel target){
        System.out.println("start tutorialtriggerspawngroup");
        
        for(int i = 0; i < entitylist.size();i++){
             figuredisplay temp = new figuredisplay(namepanel,durration,entitylist.elementAt(i));
             temp.setSize(entitylist.elementAt(i).getpicture().getWidth(),entitylist.elementAt(i).getpicture().getHeight());
             temp.setLocation(entitylist.elementAt(i).getstartx(),entitylist.elementAt(i).getstarty());
             temp.setOpaque(false);
             namepanel.addanimationcomponent(temp);
             animationcomponent.add(temp);
        }
        
        target.addanimation(new  tutorialanimategroup(target,this,durration,null,entitylist,animationcomponent));
    }
