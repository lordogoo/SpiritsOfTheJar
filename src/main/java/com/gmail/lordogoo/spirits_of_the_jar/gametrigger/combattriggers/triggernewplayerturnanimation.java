...
public class triggernewplayerturnanimation extends triggeranimations
{
    ...
    public triggernewplayerturnanimation(menucontrol c,matchmodel m)
    {
        cont = c;
        match = m;
    }
    ...
    public void startanimation(gamepanel target){
        //target.addanimation(new playerturnstartanimation(target,this,40,new Color(0,0,0,150),match.getplayerturnnum()));
        //target.addanimationdisplay();
        
        animationcomponent = new textdisplay(target,durration,match.getplayerturnnum());
    ...
    public void endanimation(gamepanel target){
        ...
        target.addtrigger(new triggerplayerdrawcard(cont,match));
     ...
     public class textdisplay extends animationscreenpanel
    {
       ...
       public textdisplay(gamepanel gp,int durration,int turnnum)
       {
          super(gp,durration);
          texta = "turn "+turnnum;
          textb = "It's your turn";
          textframe = 0;
          textframedurration = (durration*5)/10;
       }
       ...
       public void paintComponent(Graphics g){
        ...
        target.drawoutlinetext(g2d,"Arial",texta,textadx,textady,Color.black,myblue);
        ...
        target.drawoutlinetext(g2d,"Arial",textb,textbdx,textbdy,Color.black,myblue);
       }
