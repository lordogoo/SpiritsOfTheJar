...
public class triggerplayerkillnpc extends dialogtrigger
{



    public triggerplayerkillnpc(menucontrol m)
    {
        super(m);
    }
    ...
    public void cleanup(){
        ((npceventmodel)cont.getevent()).getactivated().setalive(false);
