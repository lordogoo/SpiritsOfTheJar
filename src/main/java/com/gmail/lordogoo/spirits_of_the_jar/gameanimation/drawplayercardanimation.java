...
public class drawplayercardanimation extends animation
{
    int numcards;
    ...
    public drawplayercardanimation(gamepanel g,triggeranimations t,int durration,Color b,int nc,handcarddisplay pc,JComponent pdeck,JComponent phand)
    {
