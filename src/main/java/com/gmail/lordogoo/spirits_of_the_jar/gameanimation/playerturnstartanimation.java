...
public class playerturnstartanimation extends animation
{
    gamepanel game;
    String texta;
    String textb;
    ...
    public playerturnstartanimation(gamepanel g,triggeranimations t,int durration,Color b,int turnnum)
    {
