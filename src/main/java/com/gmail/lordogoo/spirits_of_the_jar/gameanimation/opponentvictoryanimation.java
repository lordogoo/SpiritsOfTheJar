...
/**
 * Write a description of class opponentvictoryanimation here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class opponentvictoryanimation extends animation
{
    ...
    public opponentvictoryanimation(gamepanel g,triggeranimations t,int durration,Color b,String m)
    {
        super(g,t,durration,b,0);
        game = g;
        texta = "You have been defeated";
        textb = m;
        textframe = 0;
