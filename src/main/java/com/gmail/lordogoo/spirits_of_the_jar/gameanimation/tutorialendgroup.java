...
/**
 * Write a description of class tutorialendgroup here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class tutorialendgroup extends animation
{
  
    Vector<tutorialentity> animationlist;
    Vector<animationscreenpanel> animatecomponent;
    
    public tutorialendgroup(gamepanel gp,triggeranimations t,int durration,Color b,Vector<tutorialentity> al,Vector<animationscreenpanel> ac)
    {
        super(gp,t,durration,b,0);
        animationlist = al;
        animatecomponent = ac;
        animation = new Timeline(this);
        animation.addPropertyToInterpolate("currentframe",durration,0);
